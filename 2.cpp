...
public:
    ...
    vector<int> bfsMatrica(int start) {
        ...
        cout << "Время ширины (матрица): " << duration_cast<microseconds>(time_end - time_start).count() << " мкс\n";
    ...
    vector<int> bfsSpiski(int start) {
        ...
        auto time_end = high_resolution_clock::now();
        cout << "Время ширины (списки): " << duration_cast<microseconds>(time_end - time_start).count() << " мкс\n";
    ...
    vector<int> dfsMatrica(int start) {
        ...
        auto time_end = high_resolution_clock::now();
        cout << "Время глубины (матрица): " << duration_cast<microseconds>(time_end - time_start).count() << " мкс\n";
    ...
    vector<int> dfsSpiski(int start) {
        ...
        auto time_end = high_resolution_clock::now();
        cout << "Время глубины (списки): " << duration_cast<microseconds>(time_end - time_start).count() << " мкс\n";
...
int main() {
    ...
    if (versh <= 0) {
        cout << "Неверное количество вершин! Установлено значение по умолчанию: 5\n";
        versh = 5;
    }
